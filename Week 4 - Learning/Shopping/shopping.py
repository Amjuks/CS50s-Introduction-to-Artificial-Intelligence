...
def load_data(filename):
    ...
    months = {month: months.index(month) for month in months}

    with open('shopping.csv') as shopping_data:
...
def evaluate(labels, predictions):
    ...
    sensitivity = (sensitivity / positive_total)
    specificity = (specificity / negative_total)
